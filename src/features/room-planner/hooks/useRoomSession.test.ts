...
const INITIAL: RoomLayout = { widthIn: 144, heightIn: 144, ceilingHeightIn: 96, roomType: 'bedroom', features: [] };
...
describe('useRoomSession', () => {
  ...
  describe('derived dimensions', () => {
    it('widthFt and widthInchPart split correctly', () => {
      const { result } = renderHook(() => useRoomSession({ widthIn: 150, heightIn: 120, ceilingHeightIn: 96, roomType: 'bedroom', features: [] }));
